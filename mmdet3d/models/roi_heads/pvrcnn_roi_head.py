...
class PVRCNNROIHead(Base3DRoIHead):
    ...
    def loss(self, feats_dict, rpn_results_list, batch_data_samples,
             **kwargs) -> dict:
    ...
    def predict(self,
        ...
        results_list = self.predict_bbox(feats_dict, batch_input_metas,
                                         rpn_results_list, self.test_cfg)
        return results_list

    def predict_bbox(self, feats_dict, batch_input_metas, rpn_results_list,
                     test_cfg):
    ...
    def _bbox_forward(self, keypoints_feats, keypoints, rois):
    ...
    def _assign_and_sample(self, proposal_list, batch_gt_instances_3d):
    ...
    def _semantic_forward_train(self, keypoint_features, keypoints,
                                batch_gt_instances_3d):
        """Train semantic head.
